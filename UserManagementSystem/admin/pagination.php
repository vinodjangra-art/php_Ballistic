...
// Students pagination
$stmt = $conn->prepare("SELECT COUNT(id) AS total FROM users WHERE role = 'student' and score = 0");
$stmt->execute();
...
$stmt = $conn->prepare("SELECT * FROM users WHERE role = 'student' and score = 0 LIMIT :start_from, :page_size");
